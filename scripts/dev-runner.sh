#!/usr/bin/env bash
# ldqis dev-runner — wraps `make <target>` invocations and writes archives
...
#
# Mirror of techne/scripts/dev-runner.sh; sister-convention parity. When
# techne's wrapper evolves, copy the changes back here.
#
# Usage:
